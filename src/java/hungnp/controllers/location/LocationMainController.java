 ...
 * @author DELL
 */
public class LocationMainController extends HttpServlet {

	private static final String ERROR = "error";
    private static final String ADD = "LocationAddController";
	private static final String SEARCH = "admin/location";
	private static final String DELETE = "LocationDeleteController";
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("Error at LocationMainController: " + e.getMessage());
        } finally{
