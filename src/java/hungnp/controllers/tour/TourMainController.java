...
public class TourMainController extends HttpServlet {
	...
	private static final String SEARCH = "admin/tour";
	private static final String DELETE = "TourDeleteController";
	private static final String EDIT = "TourEditController";
