 ...
 * @author DELL
 */
public class AdminBookingViewShowController extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			log("Error at AdminBookingViewShowController: " + e.getMessage());
		} finally{
			request.getRequestDispatcher("/admin/admin-booking-view.jsp").forward(request, response);
		}
	}
