 ...
 * @author DELL
 */
public class Booking1ShowController extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			log("Error at Booking1ShowController: " + e.getMessage());
		} finally{
			request.getRequestDispatcher("/booking/booking-1.jsp").forward(request, response);
		}
	}
