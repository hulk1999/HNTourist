 ...
 * @author DELL
 */
public class Booking4ShowController extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			log("Error at Booking4ShowController: " + e.getMessage());
		} finally{
			request.getRequestDispatcher("/booking/booking-4.jsp").forward(request, response);
		}
	}
