...
<%
	...
	List<String> tourArticleLocationList = (List) request.getAttribute("tourArticleLocationList");
...
<head>
	...
	<title>Chỉnh sửa bài viết tour - Hungnguyentourist</title>
	...
	<link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/css/admin-tour-article-edit.css">
...
<body>
	...
	<div id="main-content">
		...
		<form id="edit-tour-article-form" action="../TourArticleMainController" method="POST" onsubmit="getArticle(); return validateEditTourArticle();">

			<div class="info-group-title">SỬA BÀI VIẾT TOUR</div>
			...
			<div class="input-line-container">
				<div class="input-field-container">
					...
					<input type="text" name="duration" value="<%= dto.getDuration() %>">
				</div>
				<div class="input-field-container">
					<div class="input-label">Phương tiện (*)</div>
					<input type="text" name="transport" value="<%= dto.getTransport() %>">
				</div>
			</div>
			<div class="input-line-container">
				<div class="input-field-container">
					<div class="input-label">Điểm xuất phát (*)</div>
					<input type="text" name="departure" value="<%= dto.getDeparture() %>">
				</div>
				<div class="input-field-container">
					<div class="input-label">Điểm đến (*)</div>
					<input type="text" name="destination" value="<%= dto.getDestination() %>">
				</div>
			</div>
			...
			<div id="location-list">
				<%
				int locationCount = 0;
				for (String location : tourArticleLocationList){
					%>
	...
	<script type="text/javascript">
		...
		function validateEditTourArticle(){
			var valid = true;
			var form = document.getElementById("edit-tour-article-form");
